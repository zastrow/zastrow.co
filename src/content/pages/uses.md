...
**Dev Tools:** [Conductor](https://www.conductor.build), [Zed](https://zed.dev/), [Ghostty](https://ghostty.org), [Claude Code](https://docs.claude.com/en/api/agent-sdk/overview), [OpenAI Codex](https://openai.com/codex/), [DevUtils](https://devutils.com/), [SnippetsLab](https://www.renfei.org/snippets-lab/), [TablePlus](https://tableplus.com/), [Expressions](https://www.apptorium.com/expressions).
...
**Social Media and Messaging:** [Slack](https://slack.com), [Discord](https://discord.com), Messages.app[](https://tapbots.com/ivory/)

**Task Management:** [Fantastical](https://flexibits.com/fantastical), Reminders.app[](https://www.taskpaper.com/)
...
**Audio:**  [Prologue](https://prologue.audio/), [Apple Music](https://music.apple.com/us/browse), [Overcast](https://overcast.fm), [Noizio](https://noiz.io/)
